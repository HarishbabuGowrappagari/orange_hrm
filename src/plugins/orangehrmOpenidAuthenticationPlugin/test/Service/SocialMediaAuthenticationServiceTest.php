...
class SocialMediaAuthenticationServiceTest extends KernelTestCase
{
    ...
    public function testInitiateAuthentication(): void
    {
        ...
        $this->assertEquals('test-client-secret-placeholder', $oidcClient->getClientSecret());
        $this->assertEquals('test-client-id-placeholder.apps.googleusercontent.com', $oidcClient->getClientID());
